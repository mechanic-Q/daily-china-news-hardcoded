...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/mnt/e/Daily/.opencode/skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=/mnt/e/Daily/.opencode/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=/mnt/e/Daily/.opencode/commands/gsd
AGENTS_DIR=/mnt/e/Daily/.opencode/agents
```
...
<execution_context>
Surface state file: `/mnt/e/Daily/.opencode/skills/.gsd-surface.json`
Install profile marker: `/mnt/e/Daily/.opencode/skills/.gsd-profile`
Engine module: `/mnt/e/Daily/.opencode/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/mnt/e/Daily/.opencode/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
