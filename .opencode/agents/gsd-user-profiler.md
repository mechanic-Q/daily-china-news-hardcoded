...
<reference>
@/mnt/e/Daily/.opencode/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/mnt/e/Daily/.opencode/get-shit-done/references/user-profiling.md` to load:
