...
<required_reading>
@/mnt/e/Daily/.opencode/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/mnt/e/Daily/.opencode/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /mnt/e/Daily/.opencode
                  → checks /mnt/e/Daily/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /mnt/e/Daily/.opencode/get-shit-done
                  → writes to /mnt/e/Daily/.opencode/get-shit-done/hooks/
...
@/mnt/e/Daily/.opencode/get-shit-done/references/thinking-models-debug.md
...
- Read @/mnt/e/Daily/.opencode/get-shit-done/references/common-bug-patterns.md
