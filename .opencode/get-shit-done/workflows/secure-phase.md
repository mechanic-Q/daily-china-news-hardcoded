...
```
Agent(
  prompt="Read /mnt/e/Daily/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/mnt/e/Daily/.opencode/get-shit-done/templates/SECURITY.md`
