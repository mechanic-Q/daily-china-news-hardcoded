...
```bash
INIT=$(node "/mnt/e/Daily/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/mnt/e/Daily/.opencode/get-shit-done/templates/spec.md.
