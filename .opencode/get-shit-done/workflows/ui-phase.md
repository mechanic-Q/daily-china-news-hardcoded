...
```markdown
Read /mnt/e/Daily/.opencode/agents/gsd-ui-researcher.md for instructions.
...
Template: /mnt/e/Daily/.opencode/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /mnt/e/Daily/.opencode/agents/gsd-ui-checker.md for instructions.
