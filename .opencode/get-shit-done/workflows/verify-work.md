...
<template>
@/mnt/e/Daily/.opencode/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/mnt/e/Daily/.opencode/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/mnt/e/Daily/.opencode/get-shit-done/workflows/transition.md`.
...
- Follow @/mnt/e/Daily/.opencode/get-shit-done/workflows/diagnose-issues.md
