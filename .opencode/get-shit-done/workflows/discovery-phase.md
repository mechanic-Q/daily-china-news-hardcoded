...
See /mnt/e/Daily/.opencode/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /mnt/e/Daily/.opencode/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using /mnt/e/Daily/.opencode/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /mnt/e/Daily/.opencode/get-shit-done/templates/discovery.md
...
Use /mnt/e/Daily/.opencode/get-shit-done/templates/discovery.md.
