...
```
Agent(
  prompt="Read /mnt/e/Daily/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/mnt/e/Daily/.opencode/get-shit-done/templates/VALIDATION.md`
