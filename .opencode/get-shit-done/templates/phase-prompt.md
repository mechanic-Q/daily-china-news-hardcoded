...
<!-- For checkpoint task examples and patterns, see @/mnt/e/Daily/.opencode/get-shit-done/references/checkpoints.md -->
...
See `/mnt/e/Daily/.opencode/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/mnt/e/Daily/.opencode/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/mnt/e/Daily/.opencode/get-shit-done/workflows/verify-phase.md` for verification logic.
